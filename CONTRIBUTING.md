...
2. Clone your fork: `git clone https://github.com/hrtzg/koiyo.git`
3. Navigate to the project directory: `cd koiyo`
...
If you have any questions, please [open an issue](https://github.com/hrtzg/koiyo/issues/new) for discussion.

Thank you for contributing to Koiyo!
